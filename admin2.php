				...
				<div class = "login_box">
					...
					<div class = "loginfields">
						...
						<form method = "post" id= "01_login">
							...
							<center><input style = "width: 20vw; height: 1.9vw; margin: 3.07vw 0vw 0vw 0vw;  font-family: 'Russo One', sans-serif; color: #000;" type = "text" name = "new_username" placeholder="New Username..."/></center>

							<b><p  style = "margin: 1.45vw 0vw -1.3vw 1.9vw; font-family: 'Russo One', sans-serif; font-size: 1vw; color: #000; visibility: hidden;">Show Password</p></b>
						...
						<?php
							...
							if(isset($_POST['submit'])){
								...
								if (mysqli_query($conn,$updatequery)){
									echo "<center><p style = 'color: #1eae6b; margin: 0.7vw 0vw 0vw 0vw; font-family: Russo One, sans-serif; font-size: 1vw;'>Username Successfully Updated</p></center>";
								} else{
