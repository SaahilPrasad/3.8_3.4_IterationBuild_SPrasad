			...
			<div class = "content_1">
				...
				<div class = "login_box">
					...
					<h3><form method = "post" id= "01_login">
						...
						<input style = "width: 19.6vw; height: 2.5vw; margin: 2.97vw 0vw 0vw 4.2vw;" type = "submit" value = "Register"/>
					
					</form></h3>
					
					<center><p style = "margin: -6.5vw 0vw 0vw 0vw; font-size: 1vw;">Return Back To<a href = "login.html"> Login</a></p></center>
