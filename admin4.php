				...
				<div class = "login_box">
					...
					<div class = "loginfields">
						...
						<form method = "post" id= "01_login">
							...
							<center><input style = "width: 20.5vw; height: 2.5vw; margin: 3.07vw 0vw 0vw 0vw;  font-family: 'Roboto', sans-serif; color: #fff;" type = "submit" name = "submit" value = "Delete User"/></center>
						...
						<?php
							...
							if(isset($_POST["submit"])){
								...
								if (mysqli_query($conn,$deletequery)){
									echo "<center><p style = 'color: #1eae6b; margin: 0.7vw 0vw 0vw 0vw; font-family: Roboto, sans-serif; font-size: 1vw;'>User Successfully Deleted</p></center>";
								} else{
