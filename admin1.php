		...
		<div class="grid-container">
			...
			<div class = "content_1">
				...
				<div class = "login_box">
					...
					<div class = "logintext">
						<b><h3 style = "float: right; padding: 2.7vw 0vw 0vw 0vw;">ADD USER</h3></b>
					</div>
						...
						<?php
							...
							if(isset($_POST['submit']))
								...
								if (mysqli_query($conn,$insertquery))
									{
									echo "<center><p style = 'color: #1eae6b; margin: 0.7vw 0vw 0vw 0vw; font-family: Russo One, sans-serif; font-size: 1vw;'>User Successfully Added</p></center>";
									}
								else{
